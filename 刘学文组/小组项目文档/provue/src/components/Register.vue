<template>
  <div id="login" :style="backgroundImg">
    ...
    <div id="loginBox"> 
      ...
      <el-form  label-width="0px" :v-model="registerFrom">
        <el-form-item label prop="userName">
          <el-row>
            ...
            <el-col :span="22">
              <el-input class="inps" placeholder="用户名" v-model="registerFrom.uname"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item >
          <el-row>
            <el-col :span="2">
              <span class="iconfont"> <i class="el-icon-circle-check"></i> </span>
            </el-col>
            <el-col :span="22">
              <el-input class="inps" placeholder="密码" show-password v-model="registerFrom.pwd"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item >
          <el-row>
            ...
            <el-col :span="22">
              <el-input class="inps" placeholder="确认密码" show-password v-model="passWord"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
         <el-form-item >
          <el-row>
            <el-col :span="2">
              <span class="iconfont"> <i class="el-icon-bank-card"></i> </span>
            </el-col>
            <el-col :span="22">
              <el-input  class="inps" placeholder="身份证"  
               v-model="registerFrom.proprietor.identityCard">
            </el-input> 
            </el-col>
          </el-row>
        </el-form-item>
         <el-form-item>
          <el-row>
            <el-col :span="2">
              <span class="iconfont"><i class="el-icon-mobile"></i></span>
            </el-col>
            <el-col :span="15">
              <el-input class="inps" placeholder="电话号码" v-model="registerFrom.proprietor.phone"></el-input> 
            </el-col>
        ...
        <el-form-item  >
          <el-button type="primary" round class="registerBtn" @click="regForm">注册</el-button> 
...
if(this.passWord!=this.registerFrom.pwd){

     this.$message.error("两次密码不一致");

}else{
   let url="Login/register";
             this.$axios.post(url,this.registerFrom).then(resp=>{
                this.erore=resp.data.hint;
                 this.$message({
               showClose: true,
